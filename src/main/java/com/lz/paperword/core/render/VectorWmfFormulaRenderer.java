...
final class VectorWmfFormulaRenderer {
    ...
    private static final double EQUATION_PAREN_POWER_WIDTH_SCALE = 0.913d;
    ...
    private static final double SCRIPT_RELATION_EXACT_S1_EQUATION_WIDTH_COMPENSATION = 1.107d;
