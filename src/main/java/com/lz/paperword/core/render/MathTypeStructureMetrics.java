...
final class MathTypeStructureMetrics {
    ...
    static final double SQRT_NESTED_BODY_LEFT_EXTRA_PT = 1.2d;
    ...
    static final double SQRT_TALL_CHECK_SHOULDER_X_PT = 2.7d;
    static final double SQRT_TALL_CHECK_MID_X_PT = 1.9d;
    static final double SQRT_TALL_COMPACT_CHECK_LOW_X_PT = 1.1d;
    static final double SQRT_TALL_COMPACT_CHECK_SHOULDER_X_PT = 1.9d;
