...
public class LaTeXTokenizer {
    ...
    private static final Set<String> KNOWN_COMMANDS = Set.of(
        ...
        "lambda", "mu", "nu", "xi", "pi", "uppi", "varpi",
        "rho", "varrho", "sigma", "varsigma", "tau", "upsilon",
        "phi", "varphi", "chi", "psi", "omega",
        "Gamma", "Delta", "Updelta", "Theta", "Uptheta", "Lambda", "Xi", "Pi",
        "Sigma", "Upsilon", "Phi", "Psi", "Omega",
        "times", "div", "pm", "mp", "cdot", "bullet",
        "leq", "le", "geq", "ge", "neq", "ne",
        "approx", "equiv", "sim", "backsim", "simeq", "cong", "propto",
        "prec", "succ", "preceq", "succeq",
        "perp", "parallel", "mid", "nmid", "subset", "supset", "subseteq", "supseteq",
        "in", "notin", "ni", "cup", "cap",
        "emptyset", "varnothing", "exists", "forall",
        "neg", "lnot", "land", "wedge", "lor", "vee",
        "oplus", "otimes", "infty", "partial", "nabla",
        "angle", "triangle", "bigtriangleup", "Circle", "CIRCLE", "Sun", "Diamondblack", "bigstar", "therefore", "because",
        ...
        "text", "mathrm", "mathbf", "mathit", "textit", "textbf", "emph", "mathcal", "mathbb",
        "enspace", "quad", "qquad",
        "not"
    );
